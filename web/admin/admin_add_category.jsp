...
<html>
  <head>
    ...
    <script src="compass/js/commerce.js" type="text/javascript"></script><script src="../compass/js/commerce.js" type="text/javascript"></script>
  </head>
  <body>
    <div id="page">
      <div id="header">
